window.onload = function() {
    ...
    var chart = new CanvasJS.Chart("chartContainer", {       
        ...
        data: [{
            ...
            dataPoints: [
                { label: "январь", y: 57466.787 },
                { label: "февраль", y: 49927.82 },
                { label: "март", y: 39899.388 },
                { label: "апрель", y: 37622.207 },
                { label: "май", y: 8649.948 },
                { label: "июнь", y: 8123.181 },
                { label: "июль", y: 3570.295 },
                { label: "август", y: 1709.387 },
                { label: "сентябрь", y: 1709.387 },	
                { label: "октябрь", y: 1709.387 },
                { label: "ноябрь", y: 1709.387 },
                { label: "декабрь", y: 1709.387 }	
            ]
        }]
    });
    chart.render();
